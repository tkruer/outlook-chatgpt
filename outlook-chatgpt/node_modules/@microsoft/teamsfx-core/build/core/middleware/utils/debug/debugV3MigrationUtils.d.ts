...
export declare function startBotTask(label: string): CommentJSONValue;
export declare function saveRunScript(context: MigrationContext, filename: string, script: string): Promise<void>;
