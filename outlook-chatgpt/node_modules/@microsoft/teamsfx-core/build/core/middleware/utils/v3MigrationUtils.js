...
function migrationNotificationMessage(versionForMigration) {
    ...
    const link = getDownloadLinkByVersionAndPlatform(versionForMigration.currentVersion, versionForMigration.platform);
    const res = localizeUtils_1.getLocalizedString("core.migrationV3.Message", versionMetadata_1.MetadataV2.platformVersion[versionForMigration.platform], link);
    return res;
}
