...
exports.getAppPackage = exports.updateManifestV3ForPublish = exports.updateManifestV3 = exports.updateManifest = exports.validateManifest = exports.buildTeamsAppPackage = exports.publishTeamsApp = exports.updateTeamsApp = exports.checkIfAppInDifferentAcountSameTenant = exports.createTeamsApp = void 0;
...
async function updateManifestV3ForPublish(ctx, inputs) {
    const envName = process.env.TEAMSFX_ENV;
    const teamsAppId = process.env.TEAMS_APP_ID;
    const manifestTemplatePath = inputs[question_1.CoreQuestionNames.ManifestPath];
    const driverContext = generateDriverContext(ctx, inputs);
    const buildDriver = typedi_1.Container.get(createAppPackage_1.actionName);
    const createAppPackageArgs = generateCreateAppPackageArgs(inputs.projectPath, manifestTemplatePath, envName);
    const updateTeamsAppArgs = {
        appPackagePath: createAppPackageArgs.outputZipPath,
    };
    await envUtil_1.envUtil.readEnv(inputs.projectPath, envName);
    const res = await buildDriver.run(createAppPackageArgs, driverContext);
    if (res.isErr()) {
        return teamsfx_api_1.err(res.error);
    }
...
exports.updateManifestV3ForPublish = updateManifestV3ForPublish;
